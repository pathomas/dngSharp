...
static class Cli
{
    ...
    private static void DumpStages(DngStream stream, DngContainer container, Options opts)
    {
        ...
        registry.Register(new Dng.Sdk.Codecs.UncompressedDecoder());
        registry.Register(new Dng.Sdk.Codecs.DeflateDecoder());
        registry.Register(new Dng.Sdk.Codecs.LosslessJpeg.LosslessJpegDecoder());
        ...
        if (opts.Stage2Output is not null || opts.Stage3Output is not null)
        {
            ...
            if (opts.Stage3Output is { } s3path)
            {
                ...
                if (stage3Image is not Dng.Sdk.Imaging.SimpleImage s3simple)
    ...
    private static void RenderAndSave(DngStream stream, DngContainer container, Options opts)
    {
        ...
        if (stage3 is not Dng.Sdk.Imaging.SimpleImage simpleStage3)
        ...
        Dng.Sdk.Render.HueSatMap? hueSatMap = null;
        if (result.CameraProfile is { } camProfile && camProfile.Illuminants.Count > 0)
        {
            ...
            hueSatMap = Dng.Sdk.Render.CameraColorMatrix.ResolveHueSatMap(camProfile, asShotKelvin);
        }
    ...
    /// </summary>
    private static Dng.Sdk.Primitives.DngRect? FindOpaqueBoundingBox(Dng.Sdk.Imaging.SimpleImage mask)
    {
        ...
        {
            Dng.Sdk.Pixels.PixelType.UInt8 => 255.0,
            Dng.Sdk.Pixels.PixelType.UInt16 => 65535.0,
            Dng.Sdk.Pixels.PixelType.Float32 => 1.0,
            _ => 255.0,
        };
        ...
        {
            Dng.Sdk.Pixels.PixelType.UInt8 => i => tile.AsTypedSpan<byte>()[i],
            Dng.Sdk.Pixels.PixelType.UInt16 => i => tile.AsTypedSpan<ushort>()[i],
            Dng.Sdk.Pixels.PixelType.Float32 => i => tile.AsTypedSpan<float>()[i],
            _ => null,
        };
        ...
        return new Dng.Sdk.Primitives.DngRect(top, left, bottom, right);
    }
    ...
    /// </summary>
    private static void CompositeMaskAgainstWhite(byte[] rgbBytes, Dng.Sdk.Imaging.SimpleImage? mask, int w, int h)
    {
        ...
        double maxValue = mask.PixelType switch
        {
            Dng.Sdk.Pixels.PixelType.UInt8  => 255.0,
            Dng.Sdk.Pixels.PixelType.UInt16 => 65535.0,
            Dng.Sdk.Pixels.PixelType.Float16 or Dng.Sdk.Pixels.PixelType.Float32 => 1.0,
            _ => 255.0,
        };
        ...
        {
            case Dng.Sdk.Pixels.PixelType.UInt8:
            {
            ...
            case Dng.Sdk.Pixels.PixelType.UInt16:
            {
            ...
            case Dng.Sdk.Pixels.PixelType.Float32:
            {
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine();
        Console.WriteLine("Usage: Dng.Validate [options] <file.dng> [...]");
        Console.WriteLine();
