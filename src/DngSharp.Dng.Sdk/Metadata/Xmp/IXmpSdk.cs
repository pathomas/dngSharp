...
namespace DngSharp.Dng.Sdk.Metadata.Xmp;
...
/// so:
///   <list type="bullet">
///     <item><c>DngSharp.Dng.Sdk.Xmp</c> can wrap libxmp via <c>LibraryImport</c>
...
public sealed class ThrowingXmpSdk : IXmpSdk
{
    public bool IsInitialized { get; private set; }
    public void Initialize() => IsInitialized = true;
    public IXmpMeta Parse(ReadOnlySpan<byte> packet) { DngThrow.NotYetImplemented("Wire DngSharp.Dng.Sdk.Xmp via IXmpSdk"); return null!; }
    public IXmpMeta CreateEmpty() { DngThrow.NotYetImplemented("Wire DngSharp.Dng.Sdk.Xmp via IXmpSdk"); return null!; }
    public void Dispose() => IsInitialized = false;
}
