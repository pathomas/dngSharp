...
/// <summary>
/// End-to-end CLI tests: invoke the published DngSharp.Dng.Validate binary against a
/// real sample DNG and verify it produces the expected output. The test
/// runner builds DngSharp.Dng.Validate as a transitive ProjectReference; we look up
/// its assembly path via Type.GetType("Cli, DngSharp.Dng.Validate") indirection
