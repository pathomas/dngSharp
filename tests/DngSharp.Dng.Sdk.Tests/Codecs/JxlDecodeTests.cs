...
public class JxlDecodeTests
{
    ...
    public void Decode_geometry_mismatch_throws_domain_exception()
    {
        ...
        else
        {
            ...
            stream.ReadExactly(tempBuf.AsSpan(0, offsetEntry.Type == DngSharp.Dng.Sdk.Tiff.TiffDataType.Long8 ? 8 : 4));
            offset = offsetEntry.Type == DngSharp.Dng.Sdk.Tiff.TiffDataType.Long8
            ...
            stream.ReadExactly(tempBuf.AsSpan(0, countEntry.Type == DngSharp.Dng.Sdk.Tiff.TiffDataType.Long8 ? 8 : 4));
            count = countEntry.Type == DngSharp.Dng.Sdk.Tiff.TiffDataType.Long8
                ? (long)System.Buffers.Binary.BinaryPrimitives.ReadUInt64LittleEndian(tempBuf)
                : (long)System.Buffers.Binary.BinaryPrimitives.ReadUInt32LittleEndian(tempBuf);
        }
