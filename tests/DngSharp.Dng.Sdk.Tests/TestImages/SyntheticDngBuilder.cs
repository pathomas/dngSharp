...
public static class SyntheticDngBuilder
{
    ...
    /// convention — see <see cref="DngSharp.Dng.Sdk.Primitives.DngOrientation.FromTiff"/>).
        ...
        Action<TiffIfdToWrite, bool>? configureIfd = null)
    {
        ...
        ifd.Entries.Add(TagBuilder.Ascii(DngTagCode.UniqueCameraModel, "DngSharp.Dng.Sdk Synthetic Test Camera"));
        ifd.Entries.Add(TagBuilder.Ascii(DngTagCode.Make, "DngSharp.Dng.Sdk"));
