...
public class DemosaicBilinearTests
{
    ...
    public void Stage3Builder_dispatches_cfa_to_demosaic()
    {
        ...
        var result = Stage3Builder.Build(bayer, DngSharp.Dng.Sdk.Tiff.Photometric.Cfa, RggbMosaic);
    ...
    public void Stage3Builder_cfa_without_mosaic_throws()
    {
        ...
        Assert.Throws<NotSupportedException>(() =>
            Stage3Builder.Build(bayer, DngSharp.Dng.Sdk.Tiff.Photometric.Cfa, mosaic: null));
    }

    [Fact]
    public void Stage3Builder_CanBuild_true_for_cfa_with_mosaic()
    {
        Assert.True(Stage3Builder.CanBuild(DngSharp.Dng.Sdk.Tiff.Photometric.Cfa, RggbMosaic));
    }

    [Fact]
    public void Stage3Builder_CanBuild_false_for_cfa_without_mosaic()
    {
        Assert.False(Stage3Builder.CanBuild(DngSharp.Dng.Sdk.Tiff.Photometric.Cfa, null));
    }
}
